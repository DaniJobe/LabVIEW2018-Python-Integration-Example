...
def findFaces(imgPath = 'data/test1.jpg', scalefactor = 1.1, neighbors = 5):
    #read image from file
    colored_img = cv2.imread(imgPath)
    ...
    newImagePath = os.path.splitext(imgPath)[0] + "_withFaces" + os.path.splitext(imgPath)[1]

    cv2.imwrite(newImagePath, img_copy)
    
    return os.path.abspath(newImagePath)
